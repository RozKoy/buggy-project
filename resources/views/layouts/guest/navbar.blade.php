<header x-data="{ open: false }" class="fixed left-0 right-0 z-50 px-6 py-4 lg:py-6 bg-black/5 backdrop-blur-xl">
    <div class="max-w-screen-2xl mx-auto flex flex-wrap items-center justify-between font-bold text-base sm:text-lg lg:text-xl xl:text-2xl text-[#C8A565]">
        ...
        <nav class="hidden lg:flex items-center gap-6 xl:gap-10">
            ...
            <a href="{{ route('our-track') }}" class="hover:text-white transition">Our Track</a>
