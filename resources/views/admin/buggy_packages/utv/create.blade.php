...
@section('content')
    <x-breadcrumb :breadcrumbs="[['title' => 'Home', 'url' => '#'], ['title' => 'UTV', 'url' => '/utv'], ['title' => 'create', 'url' => null]]" />
    <x-form id="submit_form" header="Add UTV" action="{{ route('admin.utv.store') }}">
        <div class="mb-6">
        ...
        <div class="mb-6">
            ...
            <x-input-field type="text" id="name" name="name" placeholder="SINGLE UTV..." value="{{ old('name') }}" required />
            <x-input-error :messages="$errors->get('name')" class="mt-2" />
        </div>
        <div class="mb-6">
            <x-label for="spec">Specification</x-label>
            <x-input-field type="text" id="spec" name="spec" placeholder="Two rides, one UTV..." value="{{ old('spec') }}" />
        ...
        <div class="mb-6">
            ...
            <x-input-field type="text" id="price" name="price" placeholder="1.000.000" value="{{ number_format(old('price'), 0, ',', '.') }}" />
