...
@section('content')
  ...
  <x-form id="submit_form" header="Add UTV" action="{{ route('admin.utv.update', $utv->id) }}">
    ...
    <div class="mb-6">
      ...
      <x-input-field type="text" id="price" name="price" placeholder="1.000.000" value="{{ number_format(old('price', $utv->price), null, ',', '.') }}" />
