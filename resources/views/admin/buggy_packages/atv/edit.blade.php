...
@section('content')
  ...
  <x-form id="submit_form" header="Add ATV" action="{{ route('admin.atv.update', $atv->id) }}">
    ...
    <div class="mb-6">
      ...
      <x-input-field type="text" id="price" name="price" placeholder="1.000.000" value="{{ number_format(old('price', $atv->price), null, ',', '.') }}" />
